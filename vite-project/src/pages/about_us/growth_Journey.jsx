...
import { Users, Award, Truck, Recycle, TrendingUp } from "lucide-react";
import {
  ResponsiveContainer,
  LineChart,
  CartesianGrid,
    ...
    <div className="w-full">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          {/* FIX: Equal-height grid using h-full and flex */}
          <div className="grid md:grid-cols-2 gap-12 items-stretch">
            ...
            <motion.div
              ...
              className="bg-linear-to-br from-blue-50 to-white p-8 rounded-2xl shadow-xl flex flex-col h-full"
            >
              <h3 className="text-2xl mb-6 text-center">
                Service Growth (2018-2024)
              </h3>

              {/* FIX: Make Chart fill height evenly */}
            ...
            >
              ...
              {/* Growth Indicator */}
              <div className="bg-linear-to-r from-blue-600 to-green-600 text-white p-6 rounded-xl mt-auto">
